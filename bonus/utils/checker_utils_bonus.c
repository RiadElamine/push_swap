...
int	ft_check_mov(char *move, t_buffer **lst_moves)
{
	if (ft_strncmp(move, "sa\n", 3) == 0)
		return (ft_moveadd_back(lst_moves, ft_movenew("sa")), 0);
	else if (ft_strncmp(move, "sb\n", 3) == 0)
		return (ft_moveadd_back(lst_moves, ft_movenew("sb")), 0);
	else if (ft_strncmp(move, "ss\n", 3) == 0)
		return (ft_moveadd_back(lst_moves, ft_movenew("ss")), 0);
	else if (ft_strncmp(move, "rra\n", 4) == 0)
		return (ft_moveadd_back(lst_moves, ft_movenew("rra")), 0);
	else if (ft_strncmp(move, "rrb\n", 4) == 0)
		return (ft_moveadd_back(lst_moves, ft_movenew("rrb")), 0);
	else if (ft_strncmp(move, "rrr\n", 4) == 0)
		return (ft_moveadd_back(lst_moves, ft_movenew("rrr")), 0);
	else if (ft_strncmp(move, "ra\n", 3) == 0)
		return (ft_moveadd_back(lst_moves, ft_movenew("ra")), 0);
	else if (ft_strncmp(move, "rb\n", 3) == 0)
		return (ft_moveadd_back(lst_moves, ft_movenew("rb")), 0);
	else if (ft_strncmp(move, "rr\n", 3) == 0)
		return (ft_moveadd_back(lst_moves, ft_movenew("rr")), 0);
	else if (ft_strncmp(move, "pa\n", 3) == 0)
		return (ft_moveadd_back(lst_moves, ft_movenew("pa")), 0);
	else if (ft_strncmp(move, "pb\n", 3) == 0)
		return (ft_moveadd_back(lst_moves, ft_movenew("pb")), 0);
	return (1);
}
